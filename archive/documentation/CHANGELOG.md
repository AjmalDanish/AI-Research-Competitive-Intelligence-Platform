...
All notable changes to the AI Research Competitive Intelligence Platform will be documented in this file.
...
- Ruff, Black, isort, mypy for backend
...
| 1.1.0 | TBD | ML features integration |
| 2.0.0 | TBD | Advanced analytics platform |