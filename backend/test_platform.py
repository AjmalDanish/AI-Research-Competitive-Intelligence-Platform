...
class PlatformTester:
    ...
    def test_auth_login(self) -> bool:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/api/v1/auth/login", json=TEST_USER, timeout=10
            )
            duration = time.time() - start_time
            ...
            if response.status_code == 200:
                ...
                if "access_token" in data:
                    ...
                    self.log_test(
                        "Authentication Login", False, "No access token in response", duration
                    )
                    return False
            else:
                self.log_test(
    ...
    def test_auth_me(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                self.log_test(
                    "Get Current User", True, f"User: {data.get('email', 'Unknown')}", duration
                )
                return True
            else:
                self.log_test(
    ...
    def test_competitors_list(self) -> bool:
        ...
        try:
            ...
            response = requests.get(
                f"{self.base_url}/api/v1/competitors", headers=headers, timeout=5
            )
            duration = time.time() - start_time
            ...
            if response.status_code == 200:
                ...
                self.log_test(
                    "Competitors List", True, f"Found {len(competitors)} competitors", duration
                )
                return True
            else:
                self.log_test(
    ...
    def test_alerts_crud(self) -> bool:
        ...
        try:
            ...
            create_response = requests.post(
                f"{self.base_url}/api/v1/alerts", headers=headers, json=alert_data, timeout=5
            )
            ...
            read_response = requests.get(
                f"{self.base_url}/api/v1/alerts", headers=headers, timeout=5
            )
            ...
            delete_response = requests.delete(
                f"{self.base_url}/api/v1/alerts/{alert_id}", headers=headers, timeout=5
            )
    ...
    def test_reports_generation(self) -> bool:
        ...
        try:
            ...
            download_response = requests.get(
                f"{self.base_url}/api/v1/reports/{report_id}/download", headers=headers, timeout=10
            )
    ...
    def test_market_trends(self) -> bool:
        ...
        try:
            headers = {"Authorization": f"Bearer {self.token}"}
            response = requests.get(
                f"{self.base_url}/api/v1/market/trends", headers=headers, timeout=5
            )
            duration = time.time() - start_time
            ...
            if response.status_code == 200:
                ...
                self.log_test("Market Trends", True, f"Found {len(trends)} market trends", duration)
                return True
            else:
                self.log_test(
                    "Market Trends", False, f"Failed with status: {response.status_code}", duration
                )
                return False
        except Exception as e:
            duration = time.time() - start_time
    ...
    def test_api_documentation(self) -> bool:
        ...
        try:
            ...
            if docs_response.status_code in [200, 307, 308] and spec_response.status_code == 200:
                self.log_test(
                    "API Documentation", True, "Documentation endpoints accessible", duration
                )
                return True
            else:
                self.log_test(
    ...
    def test_error_handling(self) -> bool:
        ...
        try:
            ...
            invalid_response = requests.get(
                f"{self.base_url}/api/v1/invalid_endpoint", headers=headers, timeout=5
            )

            # Test invalid method
            invalid_method_response = requests.post(
                f"{self.base_url}/api/v1/health", headers=headers, timeout=5
            )
            ...
            if invalid_response.status_code == 404 and invalid_method_response.status_code == 405:
                self.log_test(
                    "Error Handling", True, "Proper error responses for invalid requests", duration
                )
                return True
            else:
                self.log_test(
