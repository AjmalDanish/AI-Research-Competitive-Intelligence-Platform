...
def scraping_config():
    ...
    return ScrapingConfig(
        max_concurrent_requests=2, request_timeout=10, retry_attempts=2, respect_robots_txt=True
    )
...
class TestScrapingConfig:
    ...
    def test_custom_config(self):
        ...
        config = ScrapingConfig(
            max_concurrent_requests=10, request_timeout=60, retry_attempts=5, retry_delay=2.0
        )
