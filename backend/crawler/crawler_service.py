...
class CrawlerService:
    ...
    async def crawl_url(
        ...
        try:
            ...
            logger.info(
                f"Crawl completed: {url} - success={result.is_success}, status={result.status_code}, length={result.content_length}, duration={result.metrics.duration_seconds if result.metrics else 0}s"
            )
