...
class Settings(BaseSettings):
    ...
    # ==================== Application ====================
    APP_NAME: str = Field(
        default="AI Website Intelligence Platform",
    ...
    DATABASE_NAME: str = Field(
        default="ai_website_intelligence",
        description="Main database name"
    )
    
    TEST_DATABASE_NAME: str = Field(
        default="ai_website_intelligence_test",
    ...
    API_TITLE: str = Field(
        default="AI Website Intelligence Platform API",
    ...
    CRAWLER_TIMEOUT_ROBOTS_CHECK: int = Field(
        default=10,
        description="Robots.txt check timeout (seconds)"
    )
    
    CRAWLER_TIMEOUT_CRAWL: int = Field(
        default=30,
        description="Page crawl timeout (seconds)"
    )
    
    CRAWLER_TIMEOUT_OVERALL: int = Field(
        default=60,
        description="Overall operation timeout (seconds)"
    )
    ...
    CRAWLER_DEFAULT_TYPE: Literal["playwright", "crawl4ai"] = Field(
        default="playwright",
        description="Default crawler implementation"
    )
    ...
    CRAWLER_BROWSER_TIMEOUT: int = Field(
        default=30000,
        description="Browser operation timeout (milliseconds)"
    )
    ...
    CRAWLER_ROBOTS_CACHE_TTL: int = Field(
        default=3600,
        description="robots.txt cache TTL (seconds)"
    )
    ...
    OPENAI_API_KEY: str | None = Field(
        default=None,
        description="OpenAI API key (future milestone)"
    )
    
    ANTHROPIC_API_KEY: str | None = Field(
        default=None,
        description="Anthropic API key (future milestone)"
    )
