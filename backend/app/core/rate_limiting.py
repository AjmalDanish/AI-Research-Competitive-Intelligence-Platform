...
class RateLimiter:
    ...
    async def check_rate_limit(
        ...
        try:
            ...
            return {"allowed": True, "remaining": float('inf'), "limit": float('inf'), "reset": None}
    ...
    async def is_banned(self, identifier: str) -> bool:
        ...
        try:
            return await self.redis_client.exists(f"{self.config.REDIS_PREFIX}{identifier}:banned") > 0
        except Exception as e:
